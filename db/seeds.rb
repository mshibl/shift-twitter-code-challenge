@meg = User.new(first_name: 'Meg', last_name: 'Nakamura', email: 'meg@shiftpayments.com')
@meg.password = 123456
@meg.save!

@eugene = User.new(first_name: 'Eugene', last_name: 'Otto', email: 'eugene@shiftpayments.com')
